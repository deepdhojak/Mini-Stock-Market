      ...
      <div className="container my-4  mt-4">
        ...
        <div className="mx-auto my-2" style={{ width: '199px' }}>
          <div className="btn-group btn-group-lg" role="group" >
            <button  className="btn btn-danger mx-2 " onClick={() => !(balance < 50 )?(withdrawMoney(50), buymeta(1), buyshare(1), props.showAlert("Bought for $50 !", "success")):props.showAlert( 'Need more money to buy this Share!' , "danger")
            } >Meta</button>
        ...
        <div className="mx-auto my-2" style={{ width: '252px' }}>
          <div className="btn-group btn-group-lg" role="group" >
            <button  className="btn btn-danger mx-2 " onClick={() =>!(balance < 200 )?(withdrawMoney(200), buyamazon(1), buyshare(1), props.showAlert("Bought for $200 !", "success")):props.showAlert( 'Need more money to buy this Share!' , "danger")
            } >Amazon</button>
        ...
        <div className="mx-auto my-2" style={{ width: '210px' }}>
          <div className="btn-group btn-group-lg" role="group" >
            <button  className="btn btn-danger mx-2 " onClick={() => !(balance < 400 )?(withdrawMoney(400), buyapple(1), buyshare(1), props.showAlert("Bought for $400 !", "success")):props.showAlert( 'Need more money to buy this Share!' , "danger")
            } >Apple</button>
        ...
        <div className="mx-auto my-2" style={{ width: '212px' }}>
          <div className="btn-group btn-group-lg" role="group" >
            <button  className="btn btn-danger mx-2 " onClick={() => !(balance < 150 )?(withdrawMoney(150), buynetflix(1), buyshare(1), props.showAlert("Bought for $150 !", "success")):props.showAlert( 'Need more money to buy this Share!' , "danger")
            } >Netfix</button>
        ...
        <div className="mx-auto my-2" style={{ width: '235px' }}>
          <div className="btn-group btn-group-lg" role="group" >
            <button  className="btn btn-danger mx-2 " onClick={() => !(balance < 250 )?(withdrawMoney(250), buygoogle(1), buyshare(1), props.showAlert("Bought for $250 !", "success")):props.showAlert( 'Need more money to buy this Share!' , "danger")
            } >Google</button>
